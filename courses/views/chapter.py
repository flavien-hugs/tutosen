...
class ChapterListView(auth_mxs.LoginRequiredMixin, mxs.DetailView):
    ...
    def get_queryset(self):
        course_chapiter = self.model.objects.filter(
    ...
    def get_context_data(self, **kwargs):
        ...
        context['page_title'] = f'Course "{self.object.title}" chapiters'
        return context
...
class ChapterCreateView(
    auth_mxs.LoginRequiredMixin,
    SuccessMessageMixin, mxs.CreateView
):  
    ...
    def get_context_data(self, **kwargs):
        ...
        context['page_title'] = f'Add new chapiter this course "{self.get_object()}"'
        return context
...
class ChapterUpdateView(
    auth_mxs.LoginRequiredMixin,
    SuccessMessageMixin, mxs.UpdateView
):
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['chapiter'] = self.get_object()
        context['page_title'] = f'Update chapiter "{self.get_object().title}"'
        return context
...
class ChapterDeleteView(auth_mxs.LoginRequiredMixin, SuccessMessageMixin, mxs.DeleteView):
    model = models.CourseChapter
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['chapiter'] = self.get_object()
        context['page_title'] = f'Delete chapiter "{self.get_object()}"'
        return context
