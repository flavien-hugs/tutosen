    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "order",
                    utils.func_utils.CustomFields(
                        blank=True, verbose_name="chapiter number"
                    ),
                ),
                (
                    "title",
                ...
                (
                    "created_at",
                    models.DateField(
                        auto_now_add=True, verbose_name="date created of courses"
                    ),
                ),
                (
                    "update_at",
                    models.DateTimeField(
                        auto_now=True, verbose_name="date updated of courses"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "language",
                    models.CharField(
                        choices=[("FR", "Français"), ("ANG", "Anglais")],
                        default="FR",
                ...
                (
                    ...
                    models.ImageField(
                        ...
                        null=True,
                        upload_to=utils.func_utils.upload_image_path,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "order",
                    utils.func_utils.CustomFields(
                        blank=True, verbose_name="lesson number"
                    ),
                ),
                (
                    "access",
                    models.BooleanField(
                        default=True, verbose_name="lesson is access ?"
                    ),
                ),
                (
                    "movie",
                    models.URLField(
                        blank=True, help_text="add movies url", verbose_name="url movie"
                    ),
                ),
                (
                    "document",
                    models.FileField(
                        ...
                        upload_to=utils.func_utils.save_chapiter_content_file,
