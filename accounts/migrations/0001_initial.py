    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, verbose_name='ID')),
                ('civility', models.CharField(choices=[('M.', 'M.'), ('Mme', 'Mme'), ('Mlle', 'Mlle')], default='M.', max_length=4, verbose_name='civilité')),
                ('type', models.CharField(choices=[('TEACHER', 'Intructeur(trice)'), ('STUDENT', 'Etudiant(e)')], default='STUDENT', max_length=50, verbose_name='statut')),
                ('avatar', models.ImageField(blank=True, null=True, upload_to='image/', verbose_name='photo de profile')),
                ('brief_desc', ckeditor.fields.RichTextField(blank=True, null=True, verbose_name='brief description')),
