...
CourseFormSet = inlineformset_factory(
    models.Subject, models.Course, form=CourseForm,
    fk_name='subject', extra=1, can_delete=False
)
...
LessonFormSet = inlineformset_factory(
    models.Course, models.CourseChapter,
    form=LessonForm, extra=1, fk_name='course', can_delete=False,
)