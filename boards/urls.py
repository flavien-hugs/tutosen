...
urlpatterns = [
    ...
    path(route="<str:first_name>.<int:pk>/settings/", view=views.user_update_view, name="user_update"),
    path(route="<str:first_name>.<int:pk>/delete/", view=views.user_delete_view, name="user_delete"),
    path(route="<str:first_name>.<int:pk>/", view=views.user_detail_view, name="user_detail"),
    path(route="<str:first_name>.<int:pk>/update/description/", view=views.user_update_bio_view, name="update_bio"),

    path(route="social/", view=generic.TemplateView.as_view(
        template_name='dashboard/teacher/partials/_partial_social_profile.html',
        extra_context={'page_title': 'Ajouter vos comptes réseaux sociaux'}
        ), name='teacher_social_account_url'
    ),
