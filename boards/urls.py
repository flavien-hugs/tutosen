...
urlpatterns = [
    ...
    path('u/0/<link>/dashboard/t/subjects/', include(([
    ...
    path('u/0/<link>/dashboard/t/course/feedback/', include(([
        path(route="", view=feedback.feedback_list_view, name='list_feedback_url'),
        path(route="<slug>/", view=feedback.feedback_detail, name='detail_feedback_url'),
    ], 'boards'), namespace='feedback')),

    # /me/u/0/<link>/dashboard/t/blog/
    path('u/0/<link>/dashboard/t/blog/', include(([
        path(route="", view=blog_views.post_list_view, name='post_url'),
        path(route="add/", view=blog_views.post_create_view, name='create_post_url'),
        path(route="<slug>/update/", view=blog_views.post_update_view, name='update_post_url'),
        path(route="<slug>/delete/", view=blog_views.post_delete_view, name='delete_post_url')
    ], 'boards'), namespace='blogs')),

    # /me/u/0/<link>/dashboard/t/subject/<slug>/
    path('u/0/<link>/dashboard/t/subject/<slug>/', include(([
    ...
    path('u/0/<link>/dashboard/t/subject/<slug>/chapiter/<pk>/', include(([
