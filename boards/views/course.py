...
class CourseCreateView(
    views.SuccessMessageMixin, mixins.TeacherCourseCreateMixin, generic.CreateView
):
...
class CourseUpdateView(
    views.SuccessMessageMixin, mixins.TeacherCourseUpdateMixin, generic.UpdateView
):
